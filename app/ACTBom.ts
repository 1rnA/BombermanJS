...
function jugar() {
    ...
    let juego: any = document.getElementById("juego");
...
let intent: number = 0;
function ponerMinas() {
    let minas: any = document.getElementById("minas");
    let k = minas.value;
    k = parseInt(k);
...
function cliks(id: any) {
    ...
    for (let i = 0; i < 5; i++) {
        for (let x = 0; x < 5; x++) {
            if (i == num1 && x == num2) {
                if (columnas[i][x] == 1) {
                    let land: any = document.getElementById(id);
...
function mosIntentos() {
    ...
    let puntos: any = document.getElementById("puntos");
...
function minasRestantes() {
    let minasR = molt - joc;
    let minasRes: any = document.getElementById("minasres");
...
function ocultar(){
    let ocultar: any = document.getElementById("ocultar");
